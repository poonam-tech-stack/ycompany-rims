const SECTIONS = [
  ...
  },
  {
    ...
    imageUrl: "https://i.ibb.co/WBWwVpQ/Ladies-Tattersall-Hunt-Shirt.png",
    linkUrl: "shop?productType=shirts",
    id: "shirts",
  },
  {
  ...
  {
    title: "Stilettos",
    imageUrl: "https://i.ibb.co/84ptCMp/Stilettos.png",
    linkUrl: "shop?productType=stilettos",
    id: "stilettos",
  },
];

const MENU_ITEMS = ["ALL", "MEN", "WOMEN", "KIDS"];

export { SECTIONS, MENU_ITEMS };
